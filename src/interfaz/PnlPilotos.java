 ...
 * @author chris
 */
public class PnlPilotos extends javax.swing.JPanel {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PnlPilotos.class.getName());
    private final PilotoLogica pilotoLogica = new PilotoLogica();
    private Piloto pilotoSeleccionado = null;

    /**
     * Creates new form PnlPilotos
     */
    public PnlPilotos() {
        initComponents();
        cargarTablaPilotos();
